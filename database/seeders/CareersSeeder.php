...
class CareersSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $jobs = [
            ...
            ['title' => 'Senior Architect', 'slug' => 'senior-architect', 'department' => 'Architecture', 'location' => 'Cairo, Egypt', 'employment_type' => 'Full Time', 'summary' => 'Lead high-end architectural projects from concept to completion.', 'description' => 'Lead the design and delivery of high-end residential and commercial developments with multidisciplinary teams.', 'requirements' => "Bachelor's degree in Architecture. 5+ years of professional experience. Strong design and communication skills.", 'responsibilities' => 'Lead architectural projects from concept to completion. Develop functional and sustainable design solutions. Coordinate with engineers, consultants, and project teams.'],
            ['title' => 'Project Engineer', 'slug' => 'project-engineer', 'department' => 'Engineering', 'location' => 'Cairo, Egypt', 'employment_type' => 'Full Time', 'summary' => 'Coordinate the technical delivery of ambitious developments.', 'description' => 'Oversee technical delivery, site execution, quality, and schedules across multidisciplinary teams.', 'requirements' => "Bachelor's degree in Engineering. 4+ years of development experience. Strong coordination and reporting skills.", 'responsibilities' => 'Coordinate site execution and technical delivery. Review shop drawings and submittals. Track schedules, budgets, and progress.'],
            ['title' => 'Interior Designer', 'slug' => 'interior-designer', 'department' => 'Design', 'location' => 'Cairo, Egypt', 'employment_type' => 'Full Time', 'summary' => 'Craft refined interiors that elevate everyday experience.', 'description' => 'Translate concepts into detailed, buildable interiors for residential and hospitality spaces.', 'requirements' => "Bachelor's degree in Interior Design or Architecture. 3+ years of experience. A strong portfolio of interior work.", 'responsibilities' => 'Develop interior concepts and material palettes. Produce detailed drawings and specifications. Coordinate with architects and consultants.'],
        ];
        foreach ($jobs as $job) {

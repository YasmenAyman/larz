...
class ArabicContentSeeder extends Seeder
{
    ...
    private function translateSections(): void
    {
        $translations = [
            ...
            ['contact', 'hero', ['eyebrow' => 'تواصل معنا', 'heading' => 'لنتحدث.', 'description' => 'سواء كنت تختار منزلًا أو تستكشف شراكة، نحن هنا — ونرد بسرعة.', 'primary_cta_label' => 'اطلب الأسعار والجولة', 'primary_cta_url' => '#request', 'secondary_cta_label' => 'تواصل عبر واتساب', 'secondary_cta_url' => '#whatsapp']],

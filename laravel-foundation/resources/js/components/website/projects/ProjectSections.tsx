...
export function Homes3D({ project, sections }: { project: WebsiteProject; sections: ProjectSections }) {
    ...
    return <section id="homes3d" className="bg-paper py-24 text-paper-ink sm:py-28"><div className="mx-auto max-w-[1440px] px-6 sm:px-10 lg:px-24"><Eyebrow tone="light">3D Gallery</Eyebrow><h2 className="mt-5 max-w-xl text-3xl font-light leading-[1.1] sm:text-[2.5rem]">{sections.homes3d.heading}</h2><p className="mt-4 max-w-2xl text-sm leading-relaxed text-paper-muted">{sections.homes3d.description}</p>{sections.homes3d.note && <p className="mt-3 text-xs text-paper-muted/70">{sections.homes3d.note}</p>}</div></section>;
}

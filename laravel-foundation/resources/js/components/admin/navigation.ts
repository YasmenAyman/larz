...
export const adminNavigation: AdminNavigationGroup[] = [
    { items: [{ label: 'Dashboard', href: '/admin/dashboard', permission: 'dashboard.view' }] },
    {
        ...
        items: [
            { label: 'Home Page', href: '/admin/pages/home', permission: 'pages.view', children: ['hero', 'stats', 'featured-projects', 'gallery'].map((section) => ({ label: ({ hero: 'Hero Section', stats: 'Statistics', 'featured-projects': 'Featured Projects', gallery: 'Gallery' } as Record<string, string>)[section], href: `/admin/pages/home/${section}`, permission: 'pages.view' })).concat([{ label: 'Testimonials', href: '/admin/pages/home/testimonials', permission: 'pages.view' }]) },
            { label: 'About Us', href: '/admin/pages/about', permission: 'pages.view', children: [...['hero', 'stats', 'story'].map((section) => ({ label: ({ hero: 'Hero Section', stats: 'Statistics', story: 'Our Story' } as Record<string, string>)[section], href: `/admin/pages/about/${section}`, permission: 'pages.view' })), { label: 'Awards', href: '/admin/pages/about/awards', permission: 'pages.view' }, ...['partners', 'promise-cta'].map((section) => ({ label: ({ partners: 'Partners & Affiliations', 'promise-cta': 'Promise CTA' } as Record<string, string>)[section], href: `/admin/pages/about/${section}`, permission: 'pages.view' }))] },
            { label: 'Media Page', href: '/admin/pages/media', permission: 'pages.view', children: ['hero', 'news', 'stories', 'gallery', 'newsletter'].map((section) => ({ label: ({ hero: 'Hero Section', news: 'News & Press Section', stories: 'Blogs & Insights Section', gallery: 'Photo Gallery Section', newsletter: 'Newsletter CTA' } as Record<string, string>)[section], href: `/admin/pages/media/${section}`, permission: 'pages.view' })) },
            ...
            { label: 'Contact Us', href: '/admin/pages/contact', permission: 'pages.view', children: ['hero', 'contact-methods', 'request-form', 'location-map', 'social-media'].map((section) => ({ label: ({ hero: 'Hero Section', 'contact-methods': 'Contact Methods', 'request-form': 'Request Form Settings', 'location-map': 'Location & Map', 'social-media': 'Social Media Section' } as Record<string, string>)[section], href: `/admin/pages/contact/${section}`, permission: 'pages.view' })) },
        ],
    },
    {

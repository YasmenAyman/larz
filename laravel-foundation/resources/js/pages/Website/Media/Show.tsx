                ...
                <section className="bg-paper py-20 text-paper-ink sm:py-24">
                    <div className="mx-auto grid max-w-[1000px] gap-12 md:grid-cols-[1.2fr_0.8fr] md:items-start">
                        <div className="text-sm leading-[1.9] text-paper-muted">
                            ...
                            <a href="/contact" className="mt-10 inline-flex items-center gap-3 border border-gold px-5 py-3 text-[0.62rem] tracking-[0.2em] text-paper-ink uppercase hover:bg-gold/10">Talk to us <ArrowRight className="size-3.5" /></a>
                        </div>

...
class HomeFeaturedProjectsController extends Controller
{
    public function edit(): Response
    {
        ...
        return Inertia::render('Admin/Pages/HomeFeaturedProjects', [
            'settings' => ['eyebrow' => $settings['eyebrow'] ?? 'Featured Projects', 'heading' => $settings['heading'] ?? 'Our Signature Developments', 'description' => $settings['description'] ?? 'Discover a curated selection of our most prestigious projects, designed to elevate the standard of modern living.', 'cta_label' => $settings['cta_label'] ?? 'Explore All', 'cta_url' => $settings['cta_url'] ?? '/projects', 'project_ids' => array_values(array_map('intval', $selected))],

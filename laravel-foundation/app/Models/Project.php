...
class Project extends Model
{
    ...
    protected $casts = ['completion_date' => 'date', 'price_from' => 'decimal:2', 'price_to' => 'decimal:2', 'area_min' => 'decimal:2', 'area_max' => 'decimal:2', 'latitude' => 'decimal:7', 'longitude' => 'decimal:7', 'is_featured' => 'boolean', 'is_published' => 'boolean', 'published_at' => 'datetime'];

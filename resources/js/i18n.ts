...
const translations: Record<string, string> = {
    ...
    'Subscribe': 'اشترك',
    'You are subscribed.': 'تم اشتراكك بنجاح.',
    'Thanks — you are now subscribed to the LARZ newsletter.': 'شكراً — تم اشتراكك في النشرة البريدية لـ LARZ.',
    'You are already subscribed — thanks for being a part of our newsletter.': 'أنت مشترك بالفعل — شكراً لكونك جزءاً من نشرتنا البريدية.',
    ...
    'Application received — our HR team will follow up within five business days.': 'تم استلام طلبك — سيتواصل معك فريق الموارد البشرية خلال خمسة أيام عمل.',
    'Thanks — your internship application is in good hands.': 'شكراً — طلب التدريب الخاص بك في أيدٍ أمينة.',
    'Thanks for sharing your CV — we will reach out when a matching role opens up.': 'شكراً لمشاركة سيرتك الذاتية — سنتواصل معك عند توفر وظيفة مناسبة.',
    'Name': 'الاسم',
    'Your name': 'اسمك',

    ...
    return (
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-white/10 bg-[#141417]/90 px-4 text-white backdrop-blur-md sm:px-6">
            ...
            <div className="flex items-center gap-3 text-sm">
                ...
                <a href={`/language/${nextLocale}`} className="rounded-xl border border-white/10 bg-white/5 px-3 py-1.5 text-xs font-medium text-white/70 transition-all hover:border-white/20 hover:bg-white/10 hover:text-white" aria-label={nextLocale === 'ar' ? 'التبديل إلى العربية' : 'Switch to English'}>

    ...
    return (
        <form onSubmit={submit} className="space-y-5 rounded-xl border border-slate-800 bg-slate-950 p-6">
            ...
            <div className="grid gap-5 md:grid-cols-2">
                <FormField label={tr('SEO title')} error={errors.seo_title}><input value={data.seo_title} onChange={(event) => setData('seo_title', event.target.value)} className="w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-sm" /></FormField>
                ...
                <FormField label={tr('Meta description')} error={errors.meta_description}><textarea rows={3} value={data.meta_description} onChange={(event) => setData('meta_description', event.target.value)} className="w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-sm" /></FormField>
                <FormField label={tr('Open Graph title')} error={errors.og_title}><input value={data.og_title} onChange={(event) => setData('og_title', event.target.value)} className="w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-sm" /></FormField>
                <FormField label={tr('Open Graph description')} error={errors.og_description}><textarea rows={3} value={data.og_description} onChange={(event) => setData('og_description', event.target.value)} className="w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-sm" /></FormField>

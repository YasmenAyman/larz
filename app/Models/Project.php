...
class Project extends Model
{
    ...
    protected $fillable = ['project_category_id', 'title', 'slug', 'description', 'short_description', 'location', 'address', 'status', 'project_type', 'completion_date', 'price_from', 'price_to', 'currency', 'installment_information', 'area_min', 'area_max', 'area_unit', 'hero_heading', 'hero_description', 'hero_image_id', 'logo_id', 'brochure_id', 'video_url', 'virtual_tour_url', 'map_image_id', 'overview_image_id', 'masterplan_image_id', 'latitude', 'longitude', 'is_featured', 'is_published', 'sort_order', 'published_at', 'seo_title', 'seo_description', 'canonical_url', 'robots', 'translations', 'sections'];
    ...
    public function overviewImage(): BelongsTo { return $this->belongsTo(MediaAsset::class, 'overview_image_id'); }
    public function masterplanImage(): BelongsTo { return $this->belongsTo(MediaAsset::class, 'masterplan_image_id'); }
